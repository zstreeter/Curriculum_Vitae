...
improving novel AI models with end-to-end specifications for AMD hardware. Used profilers
to pin-point bottlenecks and further optimized kernels. Directed projects that contributed
to company's AI direction at large. Worked with several large clients in numerous asks. 
Furthered understanding of AI research directions and advised how AMD can leverage these 
