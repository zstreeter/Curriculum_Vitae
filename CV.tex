...
ethic allows my résumé to be read by people in your position. Thank you for taking your
...
\NewEntry{Spring 2020}{quantumGrid}

\Description{\MarginText{Author}quantumGrid is a python package for solving a $1$-D
