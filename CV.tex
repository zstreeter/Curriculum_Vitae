...
\Description{\MarginText{Published} Travis Severt, Zachary L. Streeter, Wael Iskandar, 
  Kirk A. Larsen, Avverell Gatton, Daniel Trabert, Bethany Jochim, Brandon Griffin
  Elio G. Champenois, Matthew M. Brister, Dylan Reedy, Demitri Call, Richard Strom, Allen 
  L. Landers, Reinhard Dorner, Joshua B. Williams, Daniel S. Slaughter, Robert R. Lucchese, 
  Thorsten Weber, C. William McCurdy, Itzik Ben-Itzhak, ``\textit{Step-bystep state-selective tracking of fragmentation 
  dynamics of water dications by momentum imaging}'' Nature Communications, $\mathbf{13}$, 
  $51$ ($2022$).}
