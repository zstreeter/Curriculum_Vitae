...
Honed programming skills in C, C++, Fortran, and Python.  Used NERSC
supercomputers EDISON, Lawrencium, and CORI for running large parallel code.  Became
