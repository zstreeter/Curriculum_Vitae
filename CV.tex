...
\Description{A passionate, creative, and curious individual, with all qualities
situated firmly on a foundation of work ethic. My passion leads me to problems
that hopefully will create a better universal experience. My creativity leads me to
problems that force me to mold or drop notions that I previously held. My curiousity
allows me to listen and work with others that are not in my field. My work
ethic allows my résumé to be read by people like you. Thank you for taking your
...
\Description{\ \ \textsc{Build Process}\ \ $\cdotp$\ \ CMake, Make.}

\Description{\ \ \textsc{Markup}\ \ $\cdotp$\ \ {\LaTeX}, Markdown, ReStructuredText.}

\Description{\ \ \textsc{Debugger}\ \ $\cdotp$\ \ gdb, lldb, TotalView.}

\Description{\ \ \textsc{Profiler}\ \ $\cdotp$\ \ Nsight/visual profiler, VTune.}
...
\Description{\ \ $\cdotp$\ \ HPC in coordination with Quantum Computing.}
...
becoming a learned software developer devoted to best practices and good
documentation.  Used NERSC
supercomputers EDISON and CORI, and also a cluster called Lawrencium, for
running large (e.g. $~40+$ physical cores with $~3000+$ processors) parallel batch jobs.  Became
